...
export class userUpdateTable1585491166542 implements MigrationInterface {
    name = 'userUpdateTable1585491166542'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `user` (`id` varchar(36) NOT NULL, `email` varchar(30) NOT NULL, `name` varchar(30) NOT NULL, `password` varchar(250) NOT NULL, `height` float(5) NOT NULL, `weigth` float(5) NOT NULL, `role` enum ('ALUNO', 'PROFESSOR', 'ADMINISTRADOR', 'CHEFE') NOT NULL DEFAULT 'ALUNO', `actived` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX `IDX_e12875dfb3b1d92d7d7c5377e2` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
